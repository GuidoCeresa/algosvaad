...
class VersioneController {
    ...
    def save(Versione versioneInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'versioneInstance.label', default: 'Versione'), versioneInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'versioneInstance.label', default: 'Versione'), params.id])
                redirect action: "index", method: "GET"
            }
